parcelRequire = function (e, r, t, n) {
    ...
    "Bb20": [function (require, module, exports) {
        ...
        function e() {
            var e = ["暂时的挫折会伤及皮肉<br>而失去热忱会触及灵魂", "年年今日，灯明如昼<br>原火不灭，愿人依旧", "白鹭立雪，愚人看鹭<br>聪者观雪，智者见白", "当你来到时间的尽头<br>便会与过去未来所有因缘之人重逢", "人间归离复归离<br>借一浮生逃浮生", "在夜空所有星星熄灭的时候<br>所有梦想、所有溪流<br>都能汇入同一片大海中<br>那时我们终会相见", "除了时间，什么也没留下<br>风带来故事的种子，时间使其发芽", "浮世景色百千年依旧<br>人之在世却如白露与泡影", "今朝有酒今朝醉<br>莫管门前是与非", "我们的日子是满的<br>生命却是空的", "I know that I know nothing.<br>  --Socrates"],
                i = o(0, e.length - 1);
            t("#slogan").html(e[i])
        }
        function o(t, e) {
