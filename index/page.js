parcelRequire = function(e, r, t, n) {
	...
	"Bb20": [function(require, module, exports) {
		...
		function e() {
			var e = ["龙应该藏在云里<br>你应该藏在心里<br>——沈从文《月下小景》"寒蝉黎明之时<br>便是重生之日", "给时光以生命<br>给岁月以文明", "年年今日，灯明如昼<br>原火不灭，愿人依旧", "谁也没有见过风，更别说你和我了;谁也没有见过爱情，直到有花束拋向自己", "正因为不会发生<br>所以才叫奇迹", "每个人都有一个世界<br>安静而孤独", "当你来到时间的尽头<br>便会与过去未来所有因缘之人重逢", "在黎明到来之前<br>必须要有人稍微照亮黑暗", "人间归离复归离<br>借一浮生逃浮生", "在夜空所有星星熄灭的时候<br>所有梦想、所有溪流<br>都能汇入同一片大海中<br>那时我们终会相见", "除了时间，什么也没留下<br>风带来故事的种子，时间使其发芽", "浮世景色百千年依旧<br>人之在世却如白露与泡影", " 正是因为无法更改，无法违逆，只能接受,命运才被称之为命运"],
				i = o(0, e.length - 1);
			t("#slogan").html(e[i])
		}
		function o(t, e) {
